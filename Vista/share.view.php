...
<div  id="button_share">
    ...
    <a style="margin:5px;" href="http://www.facebook.com/sharer.php?u=<?=$site_url?>" target="_blank">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Facebook_icon_2013.svg/1024px-Facebook_icon_2013.svg.png" alt="Facebook share link" />
    </a>
    ...
    <a style="margin:5px;" href="https://twitter.com/share?url=<?=$site_url?>&amp;text=Recetas%20en%205min&amp;hashtags=RecetasEn5min" target="_blank">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Twitter-logo.svg/1024px-Twitter-logo.svg.png" alt="Twitter share link" />
    </a>
</div>